...
class SNAKE:
    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            #what direction is the snake heading
            if index == 0:
    ...
    def update_head_graphics(self):
        #vektoritega omavahel suhe, lahutad ühest teise et positsiooni leida teise suhtes
...
class MAIN:
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left, apple_rect.top, apple_rect.width + score_rect.width * 2, apple_rect.height)

        pygame.draw.rect(screen,(167, 209, 61), bg_rect)
        screen.blit(score_surface, score_rect)
        screen.blit(apple, apple_rect)
        #make frame around counter
        pygame.draw.rect(screen, (56, 74, 12), bg_rect,2)

#make screen, clock, surface, font
pygame.init()
cell_size = 40
cell_number = 20
...
game_font = pygame.font.Font("IHATCS__.TTF", 30)

main_game = MAIN()

#create timer for snake movement
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_RIGHT:
                if main_game.snake.direction.x != -1:
                    main_game.snake.direction = Vector2(1,0)
    #add colour and call snake and fruit
    screen.fill((175,215,70))
    main_game.draw_elements()
    pygame.display.update()
    # make framerate stable
    clock.tick(60)